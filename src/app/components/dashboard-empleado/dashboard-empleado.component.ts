...
export class DashboardEmpleadoComponent implements OnInit, AfterViewInit {
  ...
  enviarReporte() {
    const mensaje = `send?phone=51913809770&text=*Reporte de Problema*%0A*DNI:* ${this.dni}%0A*Teléfono:* ${this.telefono}%0A*Descripción del Problema:* ${this.descripcionReporte}%0A*Nombre:* ${this.apel_nomb}%0A*Email:* ${this.gmail}`;
